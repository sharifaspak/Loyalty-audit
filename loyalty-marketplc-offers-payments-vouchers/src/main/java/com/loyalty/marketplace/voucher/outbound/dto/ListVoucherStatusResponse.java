...
public class ListVoucherStatusResponse {

	CommonApiStatus apiStatus;
	ListVoucherStatusResult result;
	
	public ListVoucherStatusResponse(String externalTransactionId) {
		if (null == externalTransactionId) {
			externalTransactionId="";
		}
		apiStatus = new CommonApiStatus(externalTransactionId);
		result = new ListVoucherStatusResult();
