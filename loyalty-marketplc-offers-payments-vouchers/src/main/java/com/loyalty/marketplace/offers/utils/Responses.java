...
public class Responses {
	 ...
	 * 
	 */
	public static void setResponse(ResultResponse resultResponse, OfferErrorCodes errorResult,
			OfferSuccessCodes successResult) {
	 ...
	 * 
	 */
	public static void setErrorResponse(ResultResponse resultResponse, OfferErrorCodes errorResult) {
	 ...
	 * @param successResult
	 */
	public static void setSuccessResponse(ResultResponse resultResponse, OfferSuccessCodes successResult) {
	 ...
	 * @param error
	 */
	public static void addError(ResultResponse resultResponse, OfferErrorCodes error) {
	 ...
	 * @param message
	 */
    public static void addErrorWithMessage(ResultResponse resultResponse, OfferErrorCodes error, String message) {
     ...
     * @param message 
     */
	public static void addExceptionError(ResultResponse resultResponse, OfferExceptionCodes exception, String logId) {
	 ...
	 * @param message
	 */
	public static void addExceptionWithMessage(ResultResponse resultResponse, OfferExceptionCodes error, String message) {
	 ...
	 */
	public static boolean setResponseAfterConditionCheck(boolean conditionCheckPass, OfferErrorCodes errorResult, ResultResponse resultResponse) {
	 ...
	 * @return error not present status
	 */
	public static boolean setResponseWithMessageAfterConditionCheck(boolean conditionCheckPass, OfferErrorCodes errorResult, String message, ResultResponse resultResponse) {
	 ...
	 * @param exceptionInfo
	 */
	public static void setResponseAfterException(ResultResponse resultResponse, ExceptionInfo exceptionInfo) {
	...
	/**
	 * 
	 * @return Size of error list
	 */
	public static int getErrorSize(ResultResponse resultResponse) {
		
		return Checks.checkErrorsPresent(resultResponse)
			? resultResponse.getApiStatus().getErrors().size()
			: 0;		
	}
