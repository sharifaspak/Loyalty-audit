package com.loyality.marketplace.payments;
//package com.loyality.marketplace.merchants;
...
//
//	private static final List<String> MODEL_PACKAGE = Arrays.asList(
//			"com.loyalty.marketplace.merchants.inbound.dto");
//
...
//		for (String p : MODEL_PACKAGE) {
//			for (final ClassPath.ClassInfo info : ClassPath.from(loader).getTopLevelClassesRecursive(p)) {
