...
public class ResultResponse {
	...
	public void setSuccessAPIResponse() {
		this.apiStatus.setStatusCode(MerchantCodes.STATUS_SUCCESS.getIntId());
		this.apiStatus.setOverallStatus(MerchantCodes.STATUS_SUCCESS.getMsg());
		this.apiStatus.setMessage("");

	}

	public void setBulkErrorAPIResponse(List<Errors> errorList) {
		this.apiStatus.setStatusCode(MerchantCodes.STATUS_FAILURE.getIntId());
		this.apiStatus.setOverallStatus(MerchantCodes.STATUS_FAILURE.getMsg());
